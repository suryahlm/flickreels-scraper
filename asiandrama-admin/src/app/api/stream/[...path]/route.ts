...
const R2_ACCOUNT_ID = process.env.R2_ACCOUNT_ID || 'caa84fe6b1be065cda3836f0dac4b509';
const R2_ACCESS_KEY_ID = process.env.R2_ACCESS_KEY_ID || 'a4903ea93c248388b6e295d6cdbc8617';
const R2_SECRET_ACCESS_KEY = process.env.R2_SECRET_ACCESS_KEY || '5768603adc5e7902f35f74137771cee70510425acf39a66701d4ecc3f626dbe9';
