"""
Delete specified dramas from R2
"""
import boto3
import os
...
# Dramas to delete
dramas_to_delete = [
    "Nikah Kontrak Berujung Cinta (2537)",
    "Nyonya Muda yang Tidak Terkalahkan(Dubbing) (3764)",
    "Pelukan landak (3832)",
    "Sekata dalam Diam (1859)",
    "Nenek Muda: Kebangkitan Keluarga (1525)",
    "Nenek Muda: Kebangkitan Keluarga(Dubbing) (1976)",
]

print("="*60)
print("DELETING DRAMAS FROM R2")
print("="*60)
